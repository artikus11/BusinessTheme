...
<div id="primary" class="content-area">
					...
					<div id="services-list">
						...
						<?php if ( have_posts() ) : ?>
							...
							<div class="grid_4 <?php echo $term_string; ?> service-item" >
								<a class="service-item-link" href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'service-archive' ); ?>
	...
	<section class="well1 ins4 bg-image">
        ...
        <section class="well1">
          <div class="container">
            <h2 class="mobile-center">Прейскурант</h2>
            <div class="row">
              <div class="grid_4">
                <table class="wow fadeInUp">
                <?php 
					$services_list_price_one = ot_get_option( 'services_archive_list_price_one' );
					foreach ($services_list_price_one as $value) :
		
                 ?>
                  <tr>
                    <td><?php echo $value['services_list_item_price_title']; ?></td>
                    <td><?php echo $value['services_list_item_price_cost']; ?>&#8381;</td>
                  </tr>
              ...
              <div class="grid_4">
                <table data-wow-delay="0.2s" class="wow fadeInUp">
                  <?php 
					$services_list_price_one = ot_get_option( 'services_archive_list_price_two' );
					foreach ($services_list_price_one as $value) :
              ...
              <div class="grid_4">
                <table data-wow-delay="0.4s" class="wow fadeInUp">
                  <?php 
					$services_list_price_one = ot_get_option( 'services_archive_list_price_three' );
					foreach ($services_list_price_one as $value) :
