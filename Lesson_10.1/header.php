      ...
      <header>
        <div class="container">
          <div class="brand">
            ...
            <?php } else {?>
               <?php if (ot_get_option( 'logo_upload' )) { ?>
                <div class="brand_name"><img src="<?php echo ot_get_option( 'logo_upload' ); ?>" alt=""></div>
                <?php } else { ?>
          ...
          <a href="#header-feedback-form" class="feedback-form">
          <?php echo ot_get_option( 'feedback_title' ); ?>
