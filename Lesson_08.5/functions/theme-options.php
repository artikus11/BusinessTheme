...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'contextual_help' => array( 
      'content'       => array( 
        array(
          ...
          'content'   => '<p>' . 'Здесь можно указать описания настроек с использованием хтмл тегов.'. '</p>'
        )
      ),
    ...
    'settings'        => array( 
        array(
            'id'          => 'services_archive_tab',
            'label'       => 'Страница архива',
            'desc'        => '', 
            'type'        => 'tab',
            'section'     => 'services',
            ),
        array(
            'id'          => 'services_archive_page_title',
        ...
        array(
            'id'          => 'services_archive_special_box_title',
            'label'       => 'Заголовок блока спецуслуг',
            'desc'        => '',
            'std'         => '',
            'type'        => 'text',
            'section'     => 'services',
        ...
        array(
            'id'          => 'services_archive_special_box_desc',
            'label'       => 'Описание блока спецуслуг',
            'desc'        => '',
            'std'         => '',
            'type'        => 'textarea',
            'section'     => 'services',
        ...
        array(
            'id'          => 'services_archive_special_box_background',
            'label'       => 'Фон блока Спецуслуги', 
            'std'         => '',
            'type'        => 'background',
            'section'     => 'services',
            'operator'    => 'and'
        ...
        array(
            'id'          => 'services_archive_list',
            'label'       => 'Перечень спец услуг',
            'std'         => '',
            'type'        => 'list-item',
            'section'     => 'services',
            'settings'    => array( 
              array(
                'id'          => 'services_archive_list_item',
                'label'       => 'Услуга',
        ...
        array(
            'id'          => 'services_archive_list_price_one',
            'label'       => 'Прайс раздел 1',
            'std'         => '',
            'type'        => 'list-item',
            'section'     => 'services',
            'settings'    => array( 
              array(
                'id'          => 'services_list_item_price_title',
                'label'       => 'Название',
                'type'        => 'text',
                ),
              array(
                'id'          => 'services_list_item_price_cost',
                'label'       => 'Цена',
                'type'        => 'text',
                ),
              )
        ...
        array(
            'id'          => 'services_archive_list_price_two',
            'label'       => 'Прайс раздел 2',
            'std'         => '',
            'type'        => 'list-item',
            'section'     => 'services',
            'settings'    => array( 
        ...
        array(
            'id'          => 'services_archive_list_price_three',
            'label'       => 'Прайс раздел 3',
            'std'         => '',
            'type'        => 'list-item',
            'section'     => 'services',
            'settings'    => array( 
        ...
        'desc'        => 'Добавьте в это поле шорткод из плагина Contact Form 7',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header',
        'condition'   => 'header_feedback_on_off:is(on)',
