...
function custom_meta_boxes() {
  ...
  $meta_box_about = array(
    ...
    'fields'      => array(
        ...
        array(
            'label'       => 'Показывать Награды',
            'id'          => 'about_award_show',
            'type'        => 'on-off',
            'desc'        => 'Показывать или нет',
            'std'         => 'on'
            ),
        array(
            'label'       => 'Заголовок', 
  ...
  $meta_box_contact = array(
    ...
    'fields'      => array(
        ...
        array(
            ...
            'std'         => '600',
            'type'        => 'numeric-slider',
            'min_max_step'=> '100,900,50',
            ),
        array(
            'label'       => 'Обратная связь',
            'id'          => 'contact_feedback_tab',
            'type'        => 'tab'
            ),
        array(
            'label'       => 'Заголовок раздела', 
            'id'          => 'contact_feedback_headline',
            'type'        => 'text',
            'desc'        => '', 
            ),
        array(
            'label'       => 'Шорткод', 
            'id'          => 'contact_feedback_shortcode',
            'type'        => 'text',
            'desc'        => '', 
            ),
        )
